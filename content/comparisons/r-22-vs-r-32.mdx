...
metaDescription: "R-22 vs R-32 comparison: HCFC pure (production banned 2020) vs HFC pure (modern A2L). Different lubricants, different safety classes, R-32 ~70% higher pressure. Full replacement only — no retrofit path."
