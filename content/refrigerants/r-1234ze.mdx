...
metaTitle: "R-1234ze PT Chart, A2L HFO, GWP 7 — Chiller and Heat Pump Refrigerant"
metaDescription: "R-1234ze (1,3,3,3-tetrafluoropropene E-isomer) PT chart, A2L mildly flammable, GWP 7. Pure HFO for centrifugal chillers and high-temp heat pumps. Honeywell Solstice ze; lower pressure than R-134a."
introOneLiner: "Pure HFO (E-isomer of 1,3,3,3-tetrafluoropropene, CHF=CHCF₃) — chiller and heat pump refrigerant with GWP 7, A2L safety. Honeywell Solstice ze. Lower pressure envelope than R-134a; well-suited to centrifugal chiller designs."
...
keyStats:
  ...
  - label: GWP (100-yr)
    value: "7"
    unit: IPCC AR5
    context: Very low — atmospheric lifetime approximately 16 days
    sourceId: ipccar5
  - label: ODP
    value: "0"
...
narrative:
  ...
  phaseDownStatus: |
    R-1234ze faces no phase-down pressure — GWP 7 is below every regulatory threshold including EU F-Gas 150-GWP cap [aimact][eufgas]. R-1234ze is structurally a long-term destination refrigerant.
...
faqs:
  ...
  - q: "What's the difference between R-1234yf and R-1234ze?"
    a: |
      Both are pure HFOs with very low GWP (4 and 7 respectively per IPCC AR5). R-1234yf (2,3,3,3-tetrafluoropropene) is used dominantly in mobile AC with pressure envelope similar to R-134a. R-1234ze (1,3,3,3-tetrafluoropropene, E-isomer) is used in chillers with lower pressure envelope better matched to centrifugal compressor designs.
  ...
  - q: "What's the GWP of R-1234ze?"
    a: |
      7 per IPCC AR5 — very low [ipccar5]. The short atmospheric lifetime (~16 days) drives the low GWP. R-1234ze sits in the same low-GWP tier as R-1234yf (4), R-290 propane (3), and R-744 CO₂ (1).
...
<TechSection icon="globe" tone="emerald" title="GWP 7 — very low, long-term regulatory positioning is strong">

R-1234ze's GWP of 7 (IPCC AR5) places it in the very-low tier alongside R-1234yf (4), R-290 (3), and R-744 (1). The very-low GWP eliminates phase-down risk under EPA AIM Act, EU F-Gas Regulation, and Kigali Amendment.
