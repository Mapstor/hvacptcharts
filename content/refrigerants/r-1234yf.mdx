...
metaTitle: "R-1234yf PT Chart, A2L HFO, GWP 4 (AR4) — Mobile AC Standard"
metaDescription: "R-1234yf (2,3,3,3-tetrafluoropropene) PT chart, A2L mildly flammable. GWP 4 (IPCC AR4 / EPA SNAP basis) — strict IPCC AR5/AR6 puts the true 100-yr GWP at <1 due to ~11-day atmospheric lifetime. Dominant mobile AC refrigerant since 2017 (EU) / 2021 (US). Pure HFO, no glide, PAG / POE lubricants."
introOneLiner: "Pure HFO (2,3,3,3-tetrafluoropropene) — the global mobile AC standard refrigerant replacing R-134a in new vehicles. A2L mildly flammable, GWP 4 (AR4 / EPA SNAP basis; <1 per strict AR5), no temperature glide. Trade names Honeywell Solstice yf and Chemours Opteon YF."
...
keyStats:
  ...
  - label: GWP (100-yr)
    ...
    context: The widely-cited value (4) is the IPCC AR4 100-yr GWP, also the AIM Act / EPA SNAP exchange figure. Strict IPCC AR5 / AR6 puts the 100-yr GWP at <1 because R-1234yf's ~11-day atmospheric lifetime is far below the integration window. Use 4 for compliance/regulatory math; understand the true warming impact is essentially negligible.
    sourceId: ipccar5
  - label: ODP
    value: "0"
...
<TechSection icon="globe" tone="emerald" title="GWP — among the lowest commercial refrigerants, with two numbers to know">
