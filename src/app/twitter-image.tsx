...
/**
 * Twitter card image — same source as opengraph-image so the brand reads
 * consistently across X, Slack, Discord, LinkedIn previews. Twitter's
 * "summary_large_image" card uses the same 1200x630 dimensions as OG.
 */
