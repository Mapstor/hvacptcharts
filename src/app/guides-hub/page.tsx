      ...
      sections={[
        ...
        },
        {
          ...
          items: [
            ...
            { href: "/r-454b-vs-r-454c/", label: "R-454B vs R-454C", blurb: "Same R-32/R-1234yf components in opposite ratios: R-454B residential AC (GWP 466); R-454C LT commercial refrigeration (GWP 148, 14°F glide)." },
            { href: "/r-404a-vs-r-452a/", label: "R-404A vs R-452A", blurb: "Transport-refrigeration retrofit — 45% GWP cut, same A1 + POE, lower discharge temperature at high compression ratios." },
            { href: "/r-134a-vs-r-1234ze/", label: "R-134a vs R-1234ze(E)", blurb: "Chiller migration path — R-1234ze GWP < 1 and A2L, ~25% lower volumetric capacity than R-134a requiring compressor displacement change." },
            { href: "/r-290-vs-r-600a/", label: "R-290 vs R-600a", blurb: "Propane vs isobutane — both A3, but 5.4× pressure gap at 40°F evap. Different application classes; never interchangeable." },
            { href: "/r-12-vs-r-134a/", label: "R-12 vs R-134a", blurb: "Classic CFC to HFC retrofit — oil change, seal update, 80–90% of R-12 nameplate charge rule." },
            { href: "/r-22-vs-r-438a/", label: "R-22 vs MO99 (R-438A)", blurb: "Chemours mineral-oil-compatible R-22 retrofit — no oil change, ~85% initial / ~95% final charge, similar pressure envelope, both A1." },
            { href: "/r-404a-vs-r-448a/", label: "R-404A vs R-448A", blurb: "Honeywell Solstice N40 retrofit — 65% GWP cut (3922→1387), same A1 + POE, ~11°F glide vs R-404A's near-azeotropic behavior." },
            { href: "/r-448a-vs-r-449a/", label: "R-448A vs R-449A", blurb: "Honeywell N40 vs Chemours XP40 — peer A1 R-404A retrofits with similar GWP, pressure envelope, and service properties." },
          ],
        },
        {
        ...
        {
          heading: "Sizing & design education",
          items: [
            { href: "/hvac-load-calculation-guide/", label: "HVAC Load Calculation Guide", blurb: "Manual J 8th edition explained — 8 load components, block vs room-by-room, climate zones, envelope inputs, Manual S equipment sizing, code requirements, software, DIY vs hire. Companion to the interactive load calculator." },
            { href: "/hvac-duct-design-guide/", label: "HVAC Duct Design Guide", blurb: "Manual D explained — six system topologies, sizing methods, Total External Static Pressure budgeting, fitting losses, material selection (galvanized vs flex vs duct board), SMACNA leakage classes, IECC insulation, common installation failures. Companion to the interactive duct size calculator." },
            { href: "/hvac-system-design-guide/", label: "HVAC System Design Guide", blurb: "Design capstone — complete ACCA Manual J → S → D → T process, refrigerant choice under AIM Act, distribution-type decision (ducted/ductless/hybrid), ventilation integration, zoning + controls, IAQ integration, code compliance, design decision matrices. Cross-references every other guide on this site." },
            { href: "/hvac-controls-automation-guide/", label: "HVAC Controls & Automation Guide", blurb: "Thermostat taxonomy + smart thermostat comparison (Ecobee, Nest, Honeywell, manufacturer communicating), heat pump balance-point + aux heat configuration, multi-zone systems, building automation (BAS), communication protocols (BACnet, Modbus, Matter, Zigbee), smart home integration, utility demand response, common failures. Sourced from ASHRAE 135 (BACnet), ASHRAE Guideline 36, IECC R403.1, CTA-2045." },
            { href: "/hvac-commissioning-guide/", label: "HVAC Commissioning Guide", blurb: "Verification layer that closes the loop on Manual J + S + D: ACCA Quality Installation Standard 5, Manual T airflow balancing, refrigerant-side verification, Duct Blaster + Blower Door testing, IECC R402+R403 requirements, HERS rater integration, common commissioning failures, DIY verification." },
            { href: "/hvac-maintenance-service-guide/", label: "HVAC Maintenance & Service Guide", blurb: "Seasonal schedule (spring AC + fall furnace), the 14-point professional annual tune-up per ACCA Standard 4 + ASHRAE 180, filter strategy by MERV class, refrigerant verification, combustion safety, capacitor + contactor + amp testing, equipment-specific maintenance (heat pumps, mini-splits, geothermal, boilers), A2L safety, service contracts, ROI math." },
            { href: "/hvac-indoor-air-quality-guide/", label: "HVAC Indoor Air Quality Guide", blurb: "Five pollutant categories, the EPA three-pillar strategy (source control → ventilation → filtration), ASHRAE 62.2 mechanical ventilation requirements, MERV/HEPA filtration deep-dive, humidity control, radon testing + mitigation, mold prevention, CO life safety, indoor monitoring, wildfire smoke and post-COVID considerations. Sourced from ASHRAE 62.2 + 52.2, EPA, CDC, WHO." },
            { href: "/hvac-mechanical-ventilation-guide/", label: "HVAC Mechanical Ventilation Guide", blurb: "Companion to the IAQ guide. ASHRAE 62.2 detailed sizing, four strategy types (exhaust-only, supply-only, balanced, balanced with ERV/HRV), ERV vs HRV by climate zone, heat exchanger types, local exhaust + make-up air, ductwork integration patterns, commissioning, maintenance, IRA tax credits. Sourced from ASHRAE 62.2 + 84, AHRI 1060, HVI." },
          ],
        },
        {
          heading: "Economics & regulation",
          items: [
            { href: "/refrigerant-prices-guide/", label: "Refrigerant Prices Guide", blurb: "How AIM Act phase-down, EU F-Gas, and the virgin/reclaimed/recycled tier structure determine refrigerant prices. Sourced from 40 CFR Part 84, EU 517/2014, AHRI 700, and Hudson Technologies SEC filings. Explicit about not quoting stale spot prices." },
            { href: "/hvac-refrigerant-recovery-guide/", label: "Refrigerant Recovery Guide", blurb: "EPA Section 608 procedure: certification levels (Type I/II/III/Universal), recovery/recycling/reclamation distinctions, required equipment per AHRI 740, evacuation levels, recordkeeping, A2L handling, penalty exposure. Sourced from 40 CFR Part 82 Subpart F." },
            { href: "/hvac-energy-efficiency-guide/", label: "HVAC Energy Efficiency Guide", blurb: "SEER2/HSPF2/AFUE explained, the 2023 DOE metric transition, heat pump vs gas furnace economics by climate, real-world vs rated efficiency gap, variable-capacity tradeoffs, ENERGY STAR criteria, IRA 25C tax credits + HEEHRA/HOMES rebates. Sourced from 10 CFR Part 430, AHRI 210/240, IRS 25C." },
            { href: "/hvac-safety-procedures-guide/", label: "HVAC Safety Procedures Guide", blurb: "Complete safety reference: OSHA 29 CFR 1910 framework, lockout/tagout per 1910.147, electrical safety + arc flash + PPE per NFPA 70E, refrigerant safety covering high pressure + asphyxiation + A2L/A3 flammability per ASHRAE 15 + EPA Section 608, gas + CO safety per NFPA 54, hot work brazing per 1910.252, working at heights, confined space, PPE requirements, consumer safety (CO alarm placement, gas leak response), emergency procedures, training + certification." },
            { href: "/hvac-tools-equipment-guide/", label: "HVAC Tools & Equipment Guide", blurb: "13 tool categories: manifold gauges (analog vs digital vs smart), vacuum pumps + micron gauges, AHRI 740 recovery machines, AHRI 1380 leak detectors, combustion analyzers, multimeters + clamp meters, anemometers + manometers + capture hoods + Blower Door + Duct Blaster, brazing + tubing, thermal imagers + borescopes, hand tools, PPE per OSHA 1910, software integration, service truck outfitting tiers, explicit DIY-vs-pro matrix. Brand lineups from Fieldpiece, Yellow Jacket, Fluke, Robinair, Bacharach, Testo, Inficon, FLIR, TSI, Energy Conservatory. A2L compatibility noted throughout." },
            { href: "/hvac-retrofitting-upgrades-guide/", label: "HVAC Retrofitting & Upgrades Guide", blurb: "Three concurrent transitions: R-22 phase-out retrofit chemistry (honest assessment of 'drop-in' refrigerants — capacity loss, oil change, warranty void), AIM Act + R-410A → A2L manufacturing cutover January 2025 (and the critical fact that existing R-410A equipment is NOT A2L-convertible), heat pump conversion (cold-climate + dual-fuel + electrical service). Plus SEER2 efficiency upgrade economics, envelope-first methodology per BPI/ENERGY STAR, complete repair-vs-replace decision matrix, full IRA 25C + 25D + HEEHRA + HOMES framework per IRS guidance, ASHRAE service life data for 17 equipment categories." },
            { href: "/hvac-energy-management-guide/", label: "HVAC Energy Management Guide", blurb: "Operational energy management (distinct from equipment efficiency): ASHRAE Standard 211 audit framework (Level I/II/III), ENERGY STAR Portfolio Manager benchmarking per Standard 105, utility rate structure deep dive (kWh + kW + TOU + demand charges + ratchets), retrocommissioning (RCx) + monitoring-based commissioning (MBCx), fault detection + diagnostics (FDD), measurement + verification per IPMVP Options A/B/C/D, submetering, demand response programs, the 20-40% performance gap, ASHRAE Standard 100 + ISO 50001 frameworks, Building Performance Standards (NYC Local Law 97, Boston BERDO, Seattle BAPS, Washington CBPS, Maryland BEPS, DC BEPS, Denver Energize, Colorado statewide). Sourced from ASHRAE, IPMVP, ENERGY STAR, ISO 50001, DOE FEMP, and primary local BPS documents." },
            { href: "/hvac-building-automation-guide/", label: "HVAC Building Automation Guide", blurb: "Commercial BMS implementation deep dive (distinct from residential controls): 4-tier system architecture (field bus → field controllers → supervisory controllers → workstations), ASHRAE Guideline 36-2021 high-performance sequences of operation, points list methodology + Project Haystack tagging per Guideline 13, system integration with lighting + security + fire + elevator (NFPA 72/92), commercial BMS vendor architecture comparison (Johnson Controls + Honeywell/Niagara + Siemens + Schneider + Carrier + Trane + Distech + Reliable + KMC + Delta), cybersecurity per NIST CSF 2.0 + NIST SP 800-82 + ISA/IEC 62443 (BACnet/SC + network segmentation + supply chain attacks), cloud-connected BAS architecture, complete BMS RFP methodology, operator training (BCxP/CCP/Niagara), BMS-as-a-Service models, smart building + digital twin trends. Sourced from ASHRAE 135 + Guideline 36, NIST, ISA/IEC, NFPA." },
            { href: "/hvac-ductless-mini-split-guide/", label: "Ductless Mini-Split & VRF Guide", blurb: "Complete mini-split + variable refrigerant flow reference: 5-type taxonomy (single-zone, multi-zone, ducted mini, ceiling cassette, floor-mount), cold-climate mini-split deep dive (Mitsubishi Hyper-Heat H2i, Daikin LV Series, Bosch Climate 5000 BHP, Fujitsu Halcyon — rated to -13°F to -15°F), multi-zone branch box architecture + sizing pitfalls, commercial VRF (Mitsubishi City Multi, Daikin VRV, LG Multi V, Samsung DVM, Toshiba), Manual J sizing (still required), refrigerant lineset specs, electrical + condensate considerations, A2L charge limits per ASHRAE 15, 14-brand vendor comparison, DIY mini-splits with EPA 608 caveats (MrCool, Pioneer, Senville), 9 common installation failures, IRA 25C $2,000 qualification framework. Sourced from AHRI 210/240 + 1230, ASHRAE 15/34/90.2, EPA 608 + AIM Act, UL 60335-2-40, IRS 25C, ENERGY STAR." },
          ],
        },
